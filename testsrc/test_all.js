 ...
 *
 *      This file loads tests.js, with URL parameter of configs=all, which bring in the full
 *      test suite and run it against all configs of the Hub  (src/ and release/).
 *
...
try{
	...
	dojo.io.script.get({
		url:"../../../testsrc/tests.js?configs=all"
	});
} catch( e ) {
    doh.debug( e );
}
