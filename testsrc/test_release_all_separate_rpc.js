/*******************************************************************************
 * test_release_all_separate_rpc.js:
 ...
 *
 *      This file loads tests.js, with URL parameter of configs=release_all, which bring in the full
 *      test suite and run it against the release/std configuration.
 *
...
try{
	...
	dojo.io.script.get({
		url:"../../../testsrc/tests.js?configs=release_all_separate_rpc"
	});
} catch( e ) {
    doh.debug( e );
}
